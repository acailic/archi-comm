...
// RELEVANT FILES: ./testData.ts, @ui/components/ChallengeSelection.tsx, @ui/components/canvas/CanvasArea.tsx, @ui/components/AudioRecording.tsx, @ui/components/ui/*

// Re-export all scenarios from the modular structure
