// src/packages/audio/transcription/transcription-engines.ts
...
// RELEVANT FILES: src/lib/platform/tauri.ts, src/packages/audio/audio-manager.ts, src/shared/contracts/index.ts
