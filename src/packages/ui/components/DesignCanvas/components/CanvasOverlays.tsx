  ...
  return (
    <>
      ...
      {budgetStatus?.overBudget && (
        <div className="absolute bottom-4 right-4 z-10 rounded-md border border-amber-500/40 bg-amber-500/10 px-3 py-2 text-xs text-amber-900 shadow-sm">
          High render activity detected ({budgetStatus.rendersPerMinute}/{budgetStatus.limit} rpm).
          Consider pausing heavy updates.
        </div>
      )}
