...
export function ImportExportDropdown({
  ...
  // Listen for custom import event from DesignCanvas
  React.useEffect(() => {
    const handleImportEvent = () => {
      openModal('import');
    };

    window.addEventListener('import:trigger', handleImportEvent);
    return () => window.removeEventListener('import:trigger', handleImportEvent);
  }, [openModal]);
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            title={hasDesignData ? 'Export Design' : 'Import Design'}
          >
...
export function useImportExportShortcuts(
  ...
  React.useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {
      ...
      // Skip handling if the event target is an input element or contentEditable
