...
import { EnhancedCard } from '@ui/components/ui/enhanced-card';
...
export const ComponentPalette = React.memo(function ComponentPalette({ defaultTags }: ComponentPaletteProps = {}) {
  // Performance monitoring
  usePerformanceMonitor('ComponentPalette');
