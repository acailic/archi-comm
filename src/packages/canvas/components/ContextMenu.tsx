...
export const ContextMenu: React.FC<ContextMenuProps> = ({
  ...
  // Efficient document click listener using refs
  ...
  // Expose API through ref if needed
  React.useImperativeHandle(React.useRef<ContextMenuAPI>(), () => api, [api]);
