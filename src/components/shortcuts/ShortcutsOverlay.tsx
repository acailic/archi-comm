...
import { ToolType } from '@/shared/contracts';
...
const categoryIcons: Record<ShortcutCategory, React.ReactNode> = {
  ...
  project: (
    <svg width={20} height={20} viewBox='0 0 24 24' fill='none' className='text-indigo-500'>
      <path
          ...
          >
                    ...
                    return (
                      ...
                      >
                        <div className='flex items-center gap-3 min-w-0 flex-1'>
                          <div className='flex-shrink-0'>{categoryIcons[shortcut.category]}</div>
            ...
            <div className='p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50'>
              <div className='flex items-center justify-between text-sm text-gray-600 dark:text-gray-400'>
                ...
                <div className='text-xs'>ArchiComm v1.0.0</div>
              </div>
            </div>
          </motion.div>
        </>
