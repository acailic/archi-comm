...
import { CheckCircle, UserCheck, Layers, Mic2, BrainCog, Building2, Star, MessageCircle } from "lucide-react";
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Contact us for a free trial or demo. We're happy to help you explore Pro features!",
  },
  {
    ...
    <div className="min-h-screen bg-gradient-to-br from-white to-slate-100 flex flex-col items-center py-10 px-4">
      ...
      <div className="max-w-2xl text-center mb-12">
        ...
        <p className="text-lg md:text-xl text-gray-600 mb-6">
          Supercharge your interview prep and learning with exclusive features, advanced AI, and premium content.
        </p>
        <Button
          asChild
          size="lg"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl w-full mb-16">
        {proFeatures.map((feature) => (
          <Card key={feature.title} className="flex flex-col items-center p-6 shadow-md h-full">
            ...
            <CardContent className="text-gray-600 text-base">
              {feature.description}
            </CardContent>
          </Card>
        ))}
      ...
      <div className="max-w-2xl w-full mb-16 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8">
          <Card className="p-8 flex-1 min-w-[260px]">
            ...
            <CardContent>
              <div className="text-3xl font-extrabold text-gray-900 mb-2">$12<span className="text-lg font-normal">/mo</span></div>
          ...
          <Card className="p-8 flex-1 min-w-[260px] border-2 border-blue-600">
            ...
            <CardContent>
              ...
              <div className="text-gray-600 mb-4">Team onboarding, admin tools, and volume discounts.</div>
              <Button
                asChild
                size="lg"
                variant="outline"
      ...
      <div className="max-w-2xl w-full text-center mb-4">
        ...
        <div className="mt-3 text-gray-500 text-sm">
          Have questions? <a href="mailto:support@archicomm.com" className="underline text-blue-600">Contact us</a>
        </div>
      </div>
    </div>
  );
