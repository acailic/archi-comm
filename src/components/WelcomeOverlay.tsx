  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto text-center space-y-6">
        ...
        >
          A community tool for learning architectural design and communication. 
          Create designs, practice explanations, and improve your skills.
        </p>
        ...
        <p className="text-xs text-muted-foreground">
          Free community version • No signup required
        </p>
      </div>
    </div>
  );
