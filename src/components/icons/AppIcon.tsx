...
export const AppIcon: React.FC<AppIconProps> = ({ size = 24, className = '' }) => (
  ...
  >
    ...
    <rect x="12" y="20" width="40" height="24" rx="3" fill="none" stroke="url(#archicomm-gradient)" strokeWidth="2.5" />
    ...
    {/* Connection Lines */}
    <line x1="24" y1="27" x2="28" y2="27" stroke="url(#archicomm-accent)" strokeWidth="2" strokeLinecap="round" />
    <line x1="36" y1="27" x2="40" y2="27" stroke="url(#archicomm-accent)" strokeWidth="2" strokeLinecap="round" />
    <line x1="20" y1="30" x2="20" y2="34" stroke="url(#archicomm-accent)" strokeWidth="2" strokeLinecap="round" />
    <line x1="32" y1="30" x2="32" y2="34" stroke="url(#archicomm-accent)" strokeWidth="2" strokeLinecap="round" />
    <line x1="44" y1="30" x2="44" y2="34" stroke="url(#archicomm-accent)" strokeWidth="2" strokeLinecap="round" />
