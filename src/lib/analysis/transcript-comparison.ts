/**
 * src/lib/analysis/transcript-comparison.ts
 ...
 * RELEVANT FILES: src/shared/contracts/index.ts, src/components/ReviewScreen.tsx, src/lib/config/challenge-config.ts, src/dev/testData.ts
 */
