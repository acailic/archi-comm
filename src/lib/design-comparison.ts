 ...
 * RELEVANT FILES: src/shared/contracts/index.ts, src/lib/challenge-config.ts, src/hooks/useDesignValidation.ts, src/components/ReviewScreen.tsx
 */

import type { ArchitectureTemplate, TemplateComponent, TemplateConnection } from './challenge-config';
import type {
  DesignData,
